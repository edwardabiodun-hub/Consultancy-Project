  ...
  return (
    <>
      ...
      <article className="content shell resource-body">
        ...
        <p>OpenAI receives no respondent identity or raw answers. It receives only deterministic derived scores, confidence levels, normalized risk codes, controlled priorities, route, and deterministic capacity output. Question prompts, selected answer labels, role, company-size bands, revenue bands, and restriction answers are excluded. The draft is validated before use, and the deterministic result remains authoritative.</p>
        <p>Narrative prose is not persisted in D1. It is retained in the internal email mailbox as part of the assessment notification. Compact D1 assessment records and internal assessment notification emails are retained for up to 90 days, then deleted. The D1 cleanup is scheduled for 03:17 UTC each day; mailbox deletion follows the same operational retention policy.</p>
