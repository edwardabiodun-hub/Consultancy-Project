...
export const resources = [
  ...
  { slug:"one-big-client-risk", category:"run-without-you", type:"Video · 9 min", title:"Why One Big Client Can Destroy Your Sale", summary:"A practical look at customer concentration, revenue predictability, and the hidden dependencies buyers notice immediately.", action:"Calculate the share of revenue controlled by your three largest customers." },
  ...
  { slug:"automation-before-ai", category:"operational-friction", type:"Article · 7 min", title:"Do Not Automate a Process You Do Not Understand", summary:"Why automation magnifies unclear ownership and process variation—and the sequence that creates durable operating leverage.", action:"Map the handoffs and exceptions before selecting a tool." },
] as const;
