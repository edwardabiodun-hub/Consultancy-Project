...
test("routing follows category and recognized employee scale only", () => {
  const routes = [
    ...
    { category: "highDependency", overall: 42, employeeBand: "1-4", restrictedMarket: false, expected: "nurture" },
    { category: "highDependency", overall: 42, employeeBand: "5-9", restrictedMarket: false, expected: "nurture" },
    { category: "highDependency", overall: 42, employeeBand: "10-19", restrictedMarket: false, expected: "nurture" },
    { category: "highDependency", overall: 42, employeeBand: "20-49", restrictedMarket: false, expected: "diagnostic" },
    { category: "highDependency", overall: 42, employeeBand: "50-99", restrictedMarket: false, expected: "diagnostic" },
    { category: "highDependency", overall: 42, employeeBand: "100+", restrictedMarket: false, expected: "diagnostic" },
    ...
    { category: "highDependency", overall: 42, employeeBand: "10-49", restrictedMarket: false, expected: "nurture" },
